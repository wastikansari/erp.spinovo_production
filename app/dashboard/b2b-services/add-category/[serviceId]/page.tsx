...
import { addNewB2BCategory } from '@/lib/api/b2bService';

export default function AddB2BCategoryPage() {
  ...
  async function handleSave() {
    ...
    const result = await addNewB2BCategory(serviceId, {
