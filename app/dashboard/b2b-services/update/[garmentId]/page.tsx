...
import {
  ArrowLeft, Loader2, CheckCircle, AlertCircle, Pencil, Shirt, IndianRupee,
} from 'lucide-react';
...
import { updateB2BGarment } from '@/lib/api/b2bService';

export default function UpdateB2BGarmentPage() {
  ...
  async function handleSave() {
    ...
    const result = await updateB2BGarment(serviceId, garmentId, {
      name: name.trim(),
      price: price.trim(),
    });
    ...
    setSaving(false);
    if (result.success) {
      setAlert({ type: 'success', message: 'Garment updated successfully!' });
