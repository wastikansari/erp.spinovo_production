...
function VendorCard({
    ...
    return (
        <button
            type="button"
            onClick={onSelect}
            className={`w-full text-left rounded-xl border-2 p-3.5 transition-all duration-150 focus:outline-none ${
                selected
        ...
        >
            <div className="flex items-start gap-3">
                {/* Avatar */}
                <div className={`relative shrink-0 h-9 w-9 rounded-full flex items-center justify-center font-bold text-sm ${
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                        ...
                        <div className={`flex items-center gap-1 shrink-0 px-2 py-0.5 rounded-full text-[10px] font-bold border ${
                            isOnline
